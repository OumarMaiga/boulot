...
class DomainesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create domaine" do
    assert_difference('Domaine.count') do
      post domaines_url, params: { domaine: { nom: @domaine.nom, user_id: @domaine.user_id } }
    end
  ...
  test "should update domaine" do
    patch domaine_url(@domaine), params: { domaine: { nom: @domaine.nom, user_id: @domaine.user_id } }
