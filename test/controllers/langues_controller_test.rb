...
class LanguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create langue" do
    assert_difference('Langue.count') do
      post langues_url, params: { langue: { langue: @langue.langue, niveau: @langue.niveau, user_id: @langue.user_id } }
    end
  ...
  test "should update langue" do
    patch langue_url(@langue), params: { langue: { langue: @langue.langue, niveau: @langue.niveau, user_id: @langue.user_id } }
